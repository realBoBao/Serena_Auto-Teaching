 ...
 *
 * TIER 1: Now delegates to lib/db.js singleton for unified connection management.
...
import { getDb as getSingletonDb, runQuery, getAll as getAllRows, getOne as getOneRow } from './db.js';

// Re-export from db.js for backward compatibility
export { getSingletonDb as getDb, runQuery, getAllRows as getAllDbRows, getOneRow as getDbRow };
